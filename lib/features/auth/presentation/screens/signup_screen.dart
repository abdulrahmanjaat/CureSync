...
class _SignupScreenState extends ConsumerState<SignupScreen> {
  ...
  Future<void> _handleSignup() async {
    ...
    if (!_isTermsAccepted) {
      SnackbarService.showInfo('Please accept Terms & Conditions');
      return;
    }
    ...
    if (result.success) {
      ...
      // Router redirect handles navigation (→ role-selection since role is null)
    } else {
      SnackbarService.showError(result.error ?? 'Sign up failed');
    }
  }
        ...
        child: Stack(
          children: [
            const Positioned(
              ...
              child: AuthHeaderIllustration(type: AuthHeaderType.signup),
            ),
